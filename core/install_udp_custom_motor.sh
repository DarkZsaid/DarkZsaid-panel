...
# UDP Custom y UDPMod/Hysteria usan el mismo puerto 36712.
# Al activar UDP Custom, se apaga UDPMod para liberar el puerto.
echo "➜ Apagando UDPMod/Hysteria para liberar puerto 36712..."
systemctl stop udpmod.service >/dev/null 2>&1 || true
pkill -f 'hysteria-linux' >/dev/null 2>&1 || true
sleep 1
